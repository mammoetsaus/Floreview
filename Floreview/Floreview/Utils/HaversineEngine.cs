...
namespace Floreview.Utils
{
    class HaversineEngine
    {
        ...
        #region Functions
        public Boolean IsStoreWhitinRange(DbGeography pos1, DbGeography pos2)
        {
            double latPos1 = Convert.ToDouble(pos1.Latitude);
            double lngPos1 = Convert.ToDouble(pos1.Longitude);
            double latPos2 = Convert.ToDouble(pos2.Latitude);
            double lngPos2 = Convert.ToDouble(pos2.Longitude);
