                ...
                c => new
                    {
                        ...
                        DescriptionShortNL = c.String(),
                        DescriptionLongNL = c.String(),
                        DescriptionShortEN = c.String(),
                        DescriptionLongEN = c.String(),
                        DescriptionShortFR = c.String(),
                        DescriptionLongFR = c.String(),
                        DescriptionShortDE = c.String(),
                        DescriptionLongDE = c.String(),
